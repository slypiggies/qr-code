...
#
# Generated by export_simulation on Fri Nov 19 20:03:06 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './frame_buffer_rgb565.sh' script.

./frame_buffer_rgb565.sh -reset_run
...
./frame_buffer_rgb565.sh -noclean_files

For more information on the script, please type './frame_buffer_rgb565.sh -help'.
